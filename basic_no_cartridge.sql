...
CREATE SEQUENCE "public"."django_content_type_id_seq"
 ...
 START 29
 CACHE 1;
SELECT setval('"public"."django_content_type_id_seq"', 29, true);
...
CREATE SEQUENCE "public"."django_migrations_id_seq"
 ...
 START 37
 CACHE 1;
SELECT setval('"public"."django_migrations_id_seq"', 37, true);
...
-- ----------------------------
INSERT INTO "public"."auth_user" VALUES ('1', 'pbkdf2_sha256$30000$t14meFCEsrIX$KJaJwzQ+gf/tFyl/l74ur2esxgLygogxjYIMD3nLb3g=', '2017-04-07 15:54:48.111811+00', 't', 'admin', '', '', 'p.dermott@fermorltd.co.uk', 't', 't', '2017-04-07 15:49:40.21893+00');
...
-- ----------------------------
INSERT INTO "public"."twitter_query" VALUES ('1', 'search', 'from:stephen_mcd mezzanine', 'f');
